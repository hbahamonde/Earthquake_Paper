...
\draw[decoration={brace,raise=1pt},decorate]
  (7,4) -- node[above=5pt] {National Level} (15,4);
...
\node[draw,align=center,fill=yellow,text=black] (ArgumentD1) at (9,0) {\underline{Income Tax}\\{\bf did}\\reflect sectoral conflicts};
...
\node[draw,,align=center,fill=yellow,text=black] (ArgumentD2) at (9,2) {\underline{Income Tax}\\{\bf did not}\\reflect sectoral conflicts};
