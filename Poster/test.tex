...
\begin{poster}{
 ...
 % Title
 {\sc \LARGE {\input{/Users/hectorbahamonde/RU/Dissertation/Papers/Earthquake_Paper/title.txt}\unskip}}
 % Authors
 {Hector Bahamonde, PhD\\[1em]
 {\texttt{Hector.Bahamonde@uoh.cl}}}
 % University logo
 {
  \begin{tabular}{r}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Contribution and Findings}{name=contribution,column=0,row=0,span=2}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  Income taxation fostered via spillover effects increases state-consolidation over time in Chile. I created a novel hand-collected longitudinal dataset on Chilean earthquake death tolls. Death tolls decrease (state capacity increases) once the income tax law was implemented in 1924
  }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Gaps in the Literature}{name=abstract,column=0,below=contribution}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{enumerate}
	\item The Literature has Overlooked Fiscal Development in Developing Countries:
		\begin{itemize}
			\item Most theories explain the European cases.
			\item Focus is on external conflicts (wars): taxation and war.
			\item \emph{Fortunately}, Latin America has not seen the degree of conflict Europe had.
		\end{itemize}
	\item A measurement to capture overtime-levels of state-capacity is lacking.
		\begin{itemize}
			\item Most measurements capture contemporaneous levels of state-capacity.
			\item Experimental and observational work.
...
\end{enumerate}
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \headerbox{Sector Competition}{name=bayesim,column=2,row=0,span=2}{
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   
IMAGE HERE

   \begin{multicols}{2}
   \textbf{Imposing the Income Tax in Latin America}
   Text here
   \end{multicols}
   }
%
...
%
 ...
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   \headerbox{Argument}{name=argument,column=0,above=references,below=abstract}{
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   
\includegraphics[width=1\linewidth]{/Users/hectorbahamonde/RU/Dissertation/Papers/Earthquake_Paper/causal_path}%
   }

 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

   \headerbox{Tracking 5000 frames with a general model}{name=tracking,column=2,span=2,below=bayesim,above=bottom}{
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Texto
   }
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Earthquake}{name=map,column=1,span=1,below=bayesim,above=bottom}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
TEXTO AQUI CSM
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{Cox Proportional Hazards}{name=simulations,column=1,above=map,below=contribution}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
