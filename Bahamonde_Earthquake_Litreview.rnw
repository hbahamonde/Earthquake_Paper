...
% Argument
	...
	- Framing: 
		(1) The income tax was produce of a sectoral conflict.

		(2) Most studies on state-capacities and sectoral conflicts conceive their cases at the national level. This paper leverages subnational data on both sectoral competition and subnational state-capacities. 
