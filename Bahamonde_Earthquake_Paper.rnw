...
\title{\vspace{-15mm}\fontsize{18pt}{7pt}\selectfont\textbf{Measuring State Capacities in LA using an Infrastructural Approach: Earthquakes and Institutional Development, 1900-2000}} % Article title
