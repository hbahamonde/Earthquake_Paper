...
\begin{enumerate}
	...
	\item Earthquake death-tolls are good proxies to measure state capacities.\pause \\
	The {\bf capacity} of the state to {\bf enforce} quake-sensitive {\bf building codes} throughout the territory, is a {\bf {\color{red}reflection}} of its {\bf overall} state-capacities.
\end{enumerate}
...
\begin{frame}\frametitle{{\large Incorporation of Subnational Elites into the National State-Making Project}}
	\begin{itemize}
		\item Higher levels of subnational industrial expansion posed credible threats to the landed elites at the national level. \hyperlink{credible_threats}{\beamerbutton{Evidence}}\pause
