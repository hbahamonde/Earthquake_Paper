...
\begin{enumerate}
	...
	\item Earthquake death-tolls are good-enough proxies to measure state capacity overtime.
\end{enumerate}
...
\begin{frame}\frametitle{Early and Late Income-Tax Implementers}
        ...
        \begin{enumerate}
          \item[] {\bf Cox Model}. Sectoral outputs (\href{http://moxlad-staging.herokuapp.com/home/en?}{MOxLAD dataset}) to investigate the sectoral contribution of the {\color{red}timing}  of the implementation of the income tax in 15 Latin American countries.
...
\begin{frame}\frametitle{Summary}
	\begin{itemize}
		 ...
		 \item {\bf Income taxation} increased \emph{state capacity} overtime in Chile.
...
\begin{frame}\frametitle{{\large Measurement Paper: Earthquakes as Repeated Natural Experiments}}
 %\hspace{-1.16cm}
  \centering\includegraphics[scale=0.5]{/Users/hectorbahamonde/RU/Dissertation/Papers/Earthquake_Paper/chile_peru_map.pdf}
\end{frame}
