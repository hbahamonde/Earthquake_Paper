...
\begin{frame}\frametitle{Theory}
  \begin{itemize}
    \item Scholarly work has explored the positive influence of direct taxation on state development.
    \item Unfortunately:
      \begin{enumerate}
...
\begin{frame}\frametitle{Measurement}
	\begin{itemize}
    \item Most state formation theories put their emphasis on pre-colonial, early, or independent Latin America.
    \item Unfortunately:
      \begin{enumerate}
        \item These theories lack of a measurement able to capture levels of state capacity \emph{overtime}.
      \end{enumerate}
	\end{itemize}
\end{frame}
...
\begin{frame}\frametitle{The Spillover Effects of Taxation on State Capacity}
	...
	\begin{itemize}
		...
		\item Monitoring private incomes, and converting them into {\color{red}public property}, \emph{fosters} state development:\pause
			...
			\begin{itemize}
				\item  ``{\bf Learning-By-Doing}'': If states really want to {\color{red}{\bf tax}} its population, they \emph{will} develop---{\color{red}{\bf endogenously}}---the {\bf {\color{red}{\bf capacity}}} to do it.\pause
        \item ``{\bf Spillover Effects}'': Income taxation generated positive {\bf {\color{red}spillover effects}} for state-making, rising {\bf {\color{red}economies of scale}} of the {\bf {\color{red}operational efficiencies}} of the bureaucracy:\pause
                \begin{itemize}
                  ...
                  \item {\bf Additional layers} (bureaucracies) was cheaper at the margin.
                \end{itemize}
			\end{itemize}
...
\begin{frame}\frametitle{The Theory Should Pass The Following Test}
	
	\begin{itemize}
		%\item[{\scriptsize Not here}] The income tax law should be {\bf implemented {\color{red}earlier}} under scenarios of {\color{red}\emph{high} sectoral contestation}.\\{\footnotesize [\emph{rapid} industrial expansion]} \hyperlink{cox}{\beamerbutton{Data/Equation}} \hyperlink{cox_simulations}{\beamerbutton{Results}}\pause
...
{\input{model_poisson.txt}\unskip}
