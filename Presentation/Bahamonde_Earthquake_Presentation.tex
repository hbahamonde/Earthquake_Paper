...
\begin{frame}\frametitle{Overview}
	...
	\begin{itemize}
		...
		\item[{\tiny [{\bf Measurement}]}] Most theories provide {\bf historical} explanations for state consolidation, and {\color{red}yet}, they lack of a {\bf historical} measurement capable of capturing levels of state capacities overtime.\pause
...
\begin{frame}\frametitle{Dual Political Economy and Taxation}
	...
	\begin{itemize}
		\item \emph{``Lewis model:''} Industrialists and agriculturalists are in permanent {\bf {\color{red}conflict}}.\pause\; I {\bf {\color{red}extrapolate this conflict to politics}.\pause\; Particularly, to their respective {\color{red}sectoral preferences towards income taxation}}.\pause
...
\begin{frame}\frametitle{Taxation and State Capacities}
	...
	\begin{itemize}
		\item \emph{``Fiscal sociology:''} Income taxation offers a theory of state development.\pause
...
\begin{frame}\frametitle{Conceptualizing Contestation}
	\begin{itemize}
		...
		\item[] {\bf Industrial} expansion in the {\bf{\color{red}regions}}, challenged the {\color{red}hegemonic} {\bf agricultural} political economy.
...
\begin{frame}\frametitle{{\large Chilean Case Study}}
	\begin{itemize}
		...
		\item Contingent on the delivery of subnational public goods, industrial elites agreed to comply with the central level paying the {\bf income tax}.\pause
	...
	\begin{itemize}
		\item[Data] Subnational and national data on Chile (1907 to 2012).
				...
				\begin{itemize}
					...
					\item[{\tiny Subnational}] Complemented archival data (historical newspapers and censuses from 1907 onwards) with:
