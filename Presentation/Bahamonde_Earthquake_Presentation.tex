...
\begin{frame}\frametitle{The Theory Should Pass The Following Tests}
	...
	\begin{itemize}
		\item[] The income tax law should be {\bf implemented {\color{red}earlier}} under scenarios of {\color{red}\emph{high} sectoral contestation}.\\{\footnotesize [\emph{rapid} industrial expansion]} \hyperlink{cox}{\beamerbutton{Data/Equation}} \hyperlink{cox_simulations}{\beamerbutton{Results}}\pause
...
\subsection{Duration Models: Income Taxation and Sectoral Contestation}
...
\end{frame}    
        ...
        \miniframesoff
        \begin{frame}[plain]\frametitle{The Timming of the Implementation of the Income Tax}
 %\vspace{-0.5cm}
...
\subsection{Count Model: Spillover Effects of Income Taxation}
